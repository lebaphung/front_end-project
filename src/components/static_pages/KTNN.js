        ...
        <div className={styles.KTNNContainer}>
            ...
            <div>
                <div className={styles.content_left}>
                    <a target="_blank" className={styles.ax} href={"https://www.youtube.com/watch?v=hBlQFuPrK90&ab_channel=TrungT%C3%A2mC%C3%A2yGi%E1%BB%91ng"}>
                    ...
                    <div className={styles.div_content}>
                        <a target="_blank" className={styles.a} href={"https://www.youtube.com/watch?v=hBlQFuPrK90&ab_channel=TrungT%C3%A2mC%C3%A2yGi%E1%BB%91ng"}>TRỒNG VÀ CHĂM SÓC MÍT RUỘT ĐỎ SƠ VÀNG INDO NHANH CHO TRÁI</a>
                ...
                <div className={styles.content_right}>
                    <a target="_blank" className={styles.ax} href={"https://www.youtube.com/watch?v=uAvD51anRjc"}>
                        <img className={styles.img}
                             src={"https://trungtamcaygiongtiengiang.com/thumbs/472x354x1/upload/news/untitled-design-5233.png"}/>
                    </a>
                    <div className={styles.div_content}>
                        <a target="_blank" className={styles.a} href={"https://www.youtube.com/watch?v=uAvD51anRjc"}>THÔNG TIN VỀ GIỐNG CÂY VÚ SỮA MICA</a>
                        <p className={styles.pDate}>Ngày đăng: 1/6/2024</p>
                ...
                <div className={styles.content_left2}>
                    <a target="_blank" className={styles.ax} href={"https://www.youtube.com/watch?v=-w3KBHxvjxM"}>
                        <img className={styles.img}
                             src={"https://trungtamcaygiongtiengiang.com/thumbs/472x354x1/upload/news/thiet-ke-chua-co-ten-7861.png"}/>
                    </a>
                    <div className={styles.div_content}>
                        <a target="_blank" className={styles.a} href={"https://www.youtube.com/watch?v=-w3KBHxvjxM"}>THÔNG TIN VỀ GIỐNG CÂY LỰU ĐỎ ẤN ĐỘ</a>
                        <p className={styles.pDate}>Ngày đăng: 1/6/2024</p>
                ...
                <div className={styles.content}>
                    <a target="_blank" href={"https://www.youtube.com/watch?v=dgriJhD-g2Y"} className={styles.ax}>
                        <img className={styles.img}
                             src={"https://trungtamcaygiongtiengiang.com/thumbs/472x354x1/upload/news/tai-xuong-7414.jpeg"}/>
                    </a>
                    <div className={styles.div_content}>
                       <a target="_blank" className={styles.a} href={"https://www.youtube.com/watch?v=dgriJhD-g2Y"}>THÔNG TIN GIỐNG CÂY TÁO TÀU</a>
                        <p className={styles.pDate}>Ngày đăng: 1/6/2024</p>
