        ...
        <header>
            ...
            <nav className="navbar navbar-light" style={{ backgroundColor: "#e3f2fd" }}>
                <div className="container">
                    ...
                    <a className="navbar-brand" to="/">Trang chủ</a>
                    <a className="navbar-brand" to="/about">Về chúng tôi</a>
                    <a className="navbar-brand" to="/services">Dịch vụ</a>
                    <a className="navbar-brand" to="/architecture">Kiến trúc nhà nông</a>
                    <a className="navbar-brand" to="/contact">Liên hệ</a>
